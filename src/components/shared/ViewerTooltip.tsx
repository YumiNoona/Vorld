    ...
    >
      <AnimatePresence>
        <motion.div
          ...
          className="flex items-center gap-2 px-3 py-1.5 bg-black/80 backdrop-blur-md border border-white/10 rounded-lg shadow-2xl whitespace-nowrap pointer-events-none"
        >
          <span className="text-emerald-400 text-[8px] font-bold tracking-tighter uppercase">✦</span>
          <span className="text-[11px] font-medium text-white/90 tracking-tight">{displayText}</span>
        </motion.div>
      </AnimatePresence>
    </Html>
  );
