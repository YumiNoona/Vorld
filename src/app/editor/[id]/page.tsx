...
const ResizeHandle = ({ 
  ...
  return (
    ...
    >
      {/* The visual line - removed border */}
      <div className="w-[1px] h-full transition-all duration-300 pointer-events-none z-10" />
      ...
      <button
        ...
        className={cn(
          "absolute top-1/2 -translate-y-1/2 w-5 h-10 bg-[--bg] rounded-md flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-200 hover:bg-[--surface-low] shadow-md active:scale-90 z-[60]",
...
export default function EditorPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[--bg] overflow-hidden selection:bg-accent/20">
      <header className="h-12 px-4 flex items-center justify-between shrink-0 z-50 bg-[--bg]">
        <div className="flex items-center gap-4">
          <Link href="/dashboard/projects" className="p-1.5 rounded-lg hover:bg-[--surface-low] text-[--text-3] hover:text-[--text-1] transition-all duration-150">
        ...
        <div className="flex items-center gap-3">
          <button onClick={handleSave} disabled={isSaving || !isDirty} className={cn("h-8 px-4 rounded-md text-xs font-semibold transition-all flex items-center gap-2 active:scale-95", showSavedFeedback ? "bg-accent text-white" : "bg-[--surface-low] hover:bg-[--surface-raised] text-[--text-1] disabled:opacity-50")}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 relative bg-[--surface-low] overflow-hidden">
          {previewMode && (
          ...
          <div className="absolute bottom-6 left-6 px-3 py-2 rounded-lg bg-[#111111]/90 backdrop-blur-md border border-white/10 text-xs font-medium text-white/90 flex items-center gap-3">
